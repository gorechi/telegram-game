...
s_nightmare_probability = 3 # Вероятность того, что герой увидит кошмар во время отдыха. Рассчитывается как 1 / значение параметра
s_steal_probability = 2 # Вероятность того, что обворуют во время отдыха. Рассчитывается как 1 / значение параметра
s_fear_limit = 5 
s_hero_actions = ['бьет',
                  'калечит',
                  'терзает',
...
s_weapon_types_dictionary = [['меч', 0, 'меч', 'рубящее', False],
