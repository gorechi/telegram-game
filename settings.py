...
s_min_money_in_locked_room = 25
# Ммаксимальное количество денег в запертой комнате
s_max_money_in_locked_room = 25
# Коэффициент для рассчета ширины карты
s_map_width_coefficient = 72
# Коэффициент для рассчета высоты карты
