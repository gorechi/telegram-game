...
class ThrustingWeaponBook(Book):
    ...
    def increase_mastery(self, who) -> str:
        ...
        """
        if who.mastery['колющее']['level'] == who.mastery['колющее']['max_level']:
            return f'{who.name} {who.g('достиг','достигла')} вершины мастерства в колющем оружии и не узнает ничего нового из этой книги.'
...
class BluntgWeaponBook(Book):
    ...
    def increase_mastery(self, who) -> str:
        ...
        """
        if who.mastery['ударное']['level'] == who.mastery['ударное']['max_level']:
            return f'{who.name} {who.g('достиг','достигла')} вершины мастерства в ударном оружии и не узнает ничего нового из этой книги.'
...
class ArmorBook(Book):
    ...
    def increase_mastery(self, who) -> str:
        ...
        """
        if who.mastery['доспехи']['level'] == who.mastery['доспехи']['max_level']:
            return f'{who.name} знает о доспехах все. Эта книга не может научить {who.g("его", "ее")} ничему новому.'
